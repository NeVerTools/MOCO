...
MOCO supports ASCXML nodes, an extended SCXML language with additional functionalities. Currently, it supports the following features:
...
* :ref:`BT Ticks & Responses <bt_communication>`: to interact with Behavior Tree control nodes
* :ref:`BT Ports <bt_ports>`: to parametrize BT plugin instances
* :ref:`BT Blackboard <bt_blackboard>`: to share data across different BT plugins
