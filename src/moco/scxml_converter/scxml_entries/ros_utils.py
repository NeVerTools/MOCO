...
from moco.scxml_converter.scxml_entries import RosField, ScxmlBase
from moco.scxml_converter.scxml_entries.utils import all_non_empty_strings
...
class ScxmlRosDeclarationsContainer:
    ...
    def append_ros_declaration(self, scxml_ros_declaration: ScxmlBase) -> None:
        ...
        """
        from moco.scxml_converter.scxml_entries.scxml_ros_action_client import RosActionClient
        from moco.scxml_converter.scxml_entries.scxml_ros_action_server import RosActionServer
        from moco.scxml_converter.scxml_entries.scxml_ros_base import RosDeclaration
        from moco.scxml_converter.scxml_entries.scxml_ros_service import (
            RosServiceClient,
            RosServiceServer,
        )
        from moco.scxml_converter.scxml_entries.scxml_ros_timer import RosTimeRate
        from moco.scxml_converter.scxml_entries.scxml_ros_topic import (
            RosTopicPublisher,
            RosTopicSubscriber,
        )
