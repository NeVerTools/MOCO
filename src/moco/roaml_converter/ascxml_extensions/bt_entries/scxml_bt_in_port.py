...
from moco.roaml_converter.ascxml_extensions.bt_entries import BtGenericPortDeclaration
...
from moco.roaml_converter.scxml_entries import AscxmlConfiguration, AscxmlDeclaration
