...
"""
Helper functions used in `moco.jani_generator.scxml_helpers.scxml_to_jani_interfaces`.
"""
...
from moco.jani_generator.scxml_helpers.scxml_event import Event, EventParamType, EventsHolder
