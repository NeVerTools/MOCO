...
from moco.jani_generator.jani_entries import JaniAutomaton
...
from moco.jani_generator.scxml_helpers.scxml_to_jani import convert_scxml_root_to_jani_automaton
